...
public class Clinic {
    ...
    public void printoutInfectionReport(int inputMonthNumber) {
        ...
        // Random random = new Random(); // Generate a random infectious rate within the
        // range
        // double minInfectiousRate = infectiousCount - 0.15; // Set the range of
        // infectious rates (e.g. +-0.15)
        // double maxInfectiousRate = infectiousCount + 0.15;
        // this.CitypotentialInfected = faker.number().numberBetween(1000, 10000); //
        // City population
        ...
        // int CitypotentialInfected = (int) (this.CitypotentialInfected *
        // EstInfectiousRate);
        ...
        // //
        // System.out.println("-------------------------------------------------------------------------------------------------------------");
        // // System.out.printf("| %-15s %-15s| %-15s|","Data as of",
        // currentMonth,city);
        // // System.out.printf("\n| %-15s| %-15s| %-15s|
        ...
        // System.out.printf("\n %-18s %-18s %-18s %-18s ", currentMonth, nextMonth,
        // nextMonth2, nextMonth3);
        // System.out.printf("\n %-18s %-18s %-18s %-18s ", this.CitypotentialInfected,
        // this.CitypotentialInfected,
    ...
    public void printInfectiousCountByCityForPastThreeMonths() {
        ...
        for (Patient patient : patientdirectory.getPatients()) {
            ...
            for (Encounter encounter : patient.getEncounterHistory().getEncounterList()) {
                if (encounter.getEvent().getDate().after(threeMonthsAgo)
                        && encounter.getDiagnosis().isConfirmedInfectious()) {
