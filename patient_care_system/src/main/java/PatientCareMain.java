...
public class PatientCareMain {
    ...
    public static void main(String[] args) {
        ...
        String patientCity = randomPatient.getEncounterHistory().pickLastedEncounter().getEvent().getSite()
                .getLocation().getCity();
        ...
        // V. #1 Randomly pick group of residents recovered from infectious diseases and
        // closely monitor their mobility as the neighbourhood would like to protect the
        // rest residents.
        ConfigureAMedicalSystem config = new ConfigureAMedicalSystem();
        config.getRandomInfoAll();

        // V. #2 Potential patient on track (based on #1 and a specific location and
        // time input
        // V. #3 Calculate street infection case per day, automatically shows level of
        // risk
